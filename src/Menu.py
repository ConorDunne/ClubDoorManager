...
class MenuWindow(tkinter.Tk):
    ...
    def createWindow(self):
        ...
        importFile = tkinter.Button(
            ioFrame, text="Import", command=self.importJson)
        exportFile = tkinter.Button(
            ioFrame, text="Export", command=self.exportJson)
        ...
        memberSearch = tkinter.Button(
            searchFrame, text="Search", command=self.memberSearchID)
        memberCard = tkinter.Button(
            searchFrame, text="Scan Card", command=self.memberSearchCard)
        ...
        newMember = tkinter.Button(
            manageFrame, text="New Member", command=self.createMember)
        barcode = tkinter.Button(manageFrame, text="Barcode Reader")
        listMembers = tkinter.Button(
            manageFrame, text="List Members", command=self.viewMemberList)
